package com.jep.datastream.transformation;

import com.jep.datastream.bean.Access;
import com.jep.datastream.function.AccessConvertFunction;
import com.jep.datastream.function.AccessFlatMapFunction;
...
public class TransformationApp {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        DataStreamSource<String> source = env.readTextFile("data/access.log");
        source.map(new AccessConvertFunction()).flatMap(new AccessFlatMapFunction()).print();
